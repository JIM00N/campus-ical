...
(function () {
  ...
  function initChangelog(listEl) {
    ...
    var entries = [
      {
        date: '2026-06-21',
        title: '홍익대학교·이화여자대학교 추가 (총 9개교 지원)',
        body: '<p>홍익대학교·이화여자대학교를 추가해 <strong>총 9개교</strong>를 지원합니다.</p>'
          + '<p>두 학교 모두 공식 학사일정을 매일 자동으로 동기화하며, 수강신청·시험·휴학/복학·계절학기·학위수여식 등 주요 일정을 골라 받을 수 있습니다.</p>'
      },
      {
        date: '2026-06-21',
